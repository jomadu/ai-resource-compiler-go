...
func TestMarkdownCompiler_Name(t *testing.T) {
	m := &MarkdownCompiler{}
	if got := m.Name(); got != "markdown" {
		t.Errorf("Name() = %v, want markdown", got)
	}
}

func TestMarkdownCompiler_SupportedVersions(t *testing.T) {
	m := &MarkdownCompiler{}
...
func TestMarkdownCompiler_CompileRule(t *testing.T) {
	m := &MarkdownCompiler{}
...
func TestMarkdownCompiler_CompileRuleset(t *testing.T) {
	m := &MarkdownCompiler{}
	resource := &compiler.Resource{
		APIVersion: "ai-resource/draft",
		Kind:       "Ruleset",
...
func TestMarkdownCompiler_CompilePrompt(t *testing.T) {
	m := &MarkdownCompiler{}
	resource := &compiler.Resource{
		APIVersion: "ai-resource/draft",
		Kind:       "Prompt",
...
func TestMarkdownCompiler_CompilePromptset(t *testing.T) {
	m := &MarkdownCompiler{}
	resource := &compiler.Resource{
		APIVersion: "ai-resource/draft",
		Kind:       "Promptset",
